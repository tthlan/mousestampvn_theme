...
add_action( 'kadence_single_post_footer', 'virtue_post_footer_pagination', 20 );
function virtue_post_footer_pagination() {
    wp_link_pages(array('before' => '<nav class="mousestampvn-pagination">', 'after' => '</nav>', 'link_before'=> '<span>', 'link_after'=> '</span>'));
}

add_action( 'kadence_single_loop_post_footer', 'virtue_post_footer_tags', 10 );
add_action( 'kadence_single_post_footer', 'virtue_post_footer_tags', 10 );
