  	...
  	<div class="row">
        ...
        <div class="footercredits clearfix">
        	...
        	<p><?php if(isset($virtue['footer_text'])) { $footertext = $virtue['footer_text'];} else {$footertext = '[copyright] [the-year] [site-name] [theme-credit]';}
        		...
        		$footertext = str_replace('[the-year]','2009-' . date('Y'),$footertext);
        		$footertext = str_replace('[site-name]',get_bloginfo('name') . ' <a href="http://tthlan.info.com" target="_blank">('. $_SERVER['HTTP_HOST'] .'</a>)',$footertext);
        		$footertext = str_replace('[theme-credit]','- <a href="https://www.kadencethemes.com/" target="_blank">WordPress Theme </a>',$footertext);
        		 echo do_shortcode($footertext); ?></p>
    	</div>
      <img src="http://artcraft123.com/ccount/click.php?id=mousestampvn" style="display:none;" />
  </div>
