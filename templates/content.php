    ...
    <div class="row">
        ...
        if ($postsummery == 'img_landscape') {
            ...
            if (has_post_thumbnail($post->ID)) {
                    ...
                    <div class="imghoverclass img-margin-center" itemprop="image" itemscope
                        ...
                        <a href="<?php the_permalink() ?>" title="<?php echo esc_attr(get_the_title()); ?>">
                            <img src="<?php echo esc_url($image[0]); ?>" alt="<?php echo esc_attr(get_the_title()); ?>"
                                 ...
                                 itemprop="contentUrl"
                                 class="iconhover" <?php echo kt_get_srcset_output($image[1], $image[2], $image_src[0], $image_id); ?>>
                ...
                preg_match('/<img.+?src(?: )*=(?: )*[\'"](.*?)[\'"]/si', $post->post_content, $get_first_img);
                $thumbnailURL = $get_first_img [1];
                //$thumbnailURL = virtue_post_default_placeholder();                        $image = aq_resize($thumbnailURL, $slidewidth, $slideheight, true, false, false);
                if (empty($image[0])) {
                    $image = array($thumbnailURL, null, null);
                } ?>
                <div class="col-md-12">
                    <div class="imghoverclass img-margin-center" itemprop="image" itemscope
                         itemtype="https://schema.org/ImageObject">
                        <a href="<?php the_permalink() ?>" title="<?php echo esc_attr(get_the_title()); ?>">
                            <img src="<?php echo esc_url($image[0]); ?>" alt="<?php echo esc_attr(get_the_title()); ?>"
                                 width="<?php echo esc_attr($image[1]); ?>" height="<?php echo esc_attr($image[2]); ?>"
                                 itemprop="contentUrl" class="iconhover">
                            <meta itemprop="url" content="<?php echo esc_url($image[0]); ?>">
                            <meta itemprop="width" content="<?php echo esc_attr($image[1]) ?>">
                            <meta itemprop="height" content="<?php echo esc_attr($image[2]) ?>">
                        </a>
            ...
            $textsize = 'col-md-12'; ?>
            <div class="col-md-12">
                <div class="flexslider kt-flexslider loading" style="max-width:<?php echo esc_attr($slidewidth); ?>px;"
                     data-flex-speed="7000" data-flex-anim-speed="400" data-flex-animation="fade" data-flex-auto="true">
                    <ul class="slides">
                        <?php
                                ...
                                foreach ($attachments as $attachment) {
                                    ...
                                    <li>
                                        <a href="<?php the_permalink() ?>"
                                           alt="<?php echo esc_attr(get_the_title()); ?>" itemprop="image" itemscope
                                           itemtype="https://schema.org/ImageObject">
                                            <img src="<?php echo esc_attr($image[0]); ?>" itemprop="contentUrl"
                                                 alt="<?php echo esc_attr($alt); ?>"
                                                 width="<?php echo esc_attr($image[1]); ?>"
                                                 height="<?php echo esc_attr($image[2]); ?>" <?php echo kt_get_srcset_output($image[1], $image[2], $attachment_src[0], $attachment); ?> />
                                            <meta itemprop="url" content="<?php echo esc_url($image[0]); ?>">
                                            <meta itemprop="width" content="<?php echo esc_attr($image[1]) ?>">
                                            <meta itemprop="height" content="<?php echo esc_attr($image[2]) ?>">
                                        </a>
            ...
            <div class="col-md-5 post-image-container">
                <div class="flexslider kt-flexslider loading" data-flex-speed="7000" data-flex-anim-speed="400"
                     data-flex-animation="fade" data-flex-auto="true">
                    <ul class="slides">
                        <?php global $post;
                        $image_gallery = get_post_meta($post->ID, '_kad_image_gallery', true);
                        if (!empty($image_gallery)) {
                                        ...
                                        <a href="<?php the_permalink() ?>"
                                           ...
                                           itemtype="https://schema.org/ImageObject">
                                            <img src="<?php echo esc_url($image[0]); ?>"
                                                 alt="<?php echo esc_attr($alt); ?>" itemprop="contentUrl"
                                                 width="<?php echo esc_attr($image[1]); ?>"
                                                 height="<?php echo esc_attr($image[2]); ?>" <?php echo kt_get_srcset_output($image[1], $image[2], $attachment_src[0], $attachment); ?> />
                                            <meta itemprop="url" content="<?php echo esc_url($image[0]); ?>">
                                            <meta itemprop="width" content="<?php echo esc_attr($image[1]) ?>">
