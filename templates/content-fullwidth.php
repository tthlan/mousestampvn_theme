    ...
    <div class="row">
        ...
        if ($postsummery == 'img_landscape') {
            ...
            if (has_post_thumbnail($post->ID)) {
                ...
                <div class="col-md-12">
                    <div class="imghoverclass img-margin-center">
                        <a href="<?php the_permalink() ?>" title="<?php the_title(); ?>">
                            <img src="<?php echo esc_url($image); ?>" alt="<?php the_title(); ?>" class="iconhover"
                                 style="display:block;">
                        </a>
                    </div>
                </div>
                ...
                $get_first_img = array();
                preg_match('/<img.+?src(?: )*=(?: )*[\'"](.*?)[\'"]/si', get_the_content(), $get_first_img);
        ...
        <?php } elseif ($postsummery == 'slider_landscape') {
            $textsize = 'col-md-12'; ?>
            <div class="col-md-12">
                <div class="flexslider loading kt-flexslider" style="max-width:<?php echo esc_attr($slidewidth); ?>px;"
        ...
        <div class="<?php echo esc_attr($textsize); ?> postcontent">
            ...
            <header>
                <a href="<?php the_permalink() ?>"><h2 class="entry-title"
                                                       itemprop="name headline"><?php the_title(); ?></h2></a>
            ...
            <footer>
                ...
                $tags = get_the_tags();
                if ($tags) { ?> <span class="posttags"><i class="icon-tag"></i> <?php the_tags('', ', ', ''); ?>
                    </span><?php } ?>
            </footer>
        </div><!-- Text size -->
    </div><!-- row-->
